      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="rounded-2xl border border-[#e0daef] bg-white p-5 shadow-sm">
          ...
          <div className="mt-2 text-3xl font-black text-[#123057]">
            {data?.total_workforce ?? 0}
          </div>
          <div className="mt-1 text-xs text-slate-400 font-semibold">Active civil servants</div>
        </div>
        ...
        <div className="rounded-2xl border border-[#e0daef] bg-white p-5 shadow-sm">
          ...
          <div className="mt-2 text-3xl font-black text-[#6d5bc3]">
            {data?.department_breakdown?.length ?? 1}
          </div>
          <div className="mt-1 text-xs text-slate-400 font-semibold">Ministries represented</div>
        </div>
        ...
        <div className="rounded-2xl border border-[#e0daef] bg-white p-5 shadow-sm">
          ...
          <div className="mt-1 text-xs text-slate-400 font-semibold">Meeting role baseline</div>
        </div>
        ...
        <div className="rounded-2xl border border-[#e0daef] bg-white p-5 shadow-sm">
          ...
          <div className="mt-1 text-xs text-slate-400 font-semibold">Target for capacity building</div>
        </div>
      </div>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredEmployees.map((emp) => (
                <tr key={emp.id} className="hover:bg-purple-50/40 transition-colors">
