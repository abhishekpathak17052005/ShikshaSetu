  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {/* Card 1 */}
        <div className="rounded-2xl border border-[#f0ddd0] bg-white p-5 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="rounded-2xl border border-[#f0ddd0] bg-white p-5 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="mt-4 flex items-baseline gap-2">
            ...
            <span className="text-xs font-semibold text-slate-400">generated items</span>
          </div>
          <button
        ...
        <div className="rounded-2xl border border-[#f0ddd0] bg-white p-5 shadow-sm hover:shadow-md transition-shadow">
          ...
          <button
            ...
            className="mt-3 flex items-center gap-1 text-xs font-bold text-emerald-600 hover:underline"
          >
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-[#f0ddd0] bg-white p-6 shadow-sm lg:col-span-2">
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            ...
            <button
              onClick={() => onNavigate("Question Review")}
              className="rounded-lg bg-orange-50 px-3 py-1.5 text-xs font-bold text-[#c2510e] hover:bg-orange-100 transition-colors"
            >
              Open Studio
            </button>
          </div>
          ...
          {/* Workflow Notice */}
          <div className="mt-6 rounded-xl bg-slate-50 p-4 border border-slate-200/60 flex items-start gap-3">
        ...
        <div className="flex flex-col justify-between rounded-2xl border border-[#f0ddd0] bg-white p-6 shadow-sm">
          <div>
            ...
            <div className="mt-5 space-y-3">
              <button
                onClick={() => onNavigate("Upload Material")}
                className="flex w-full items-center justify-between rounded-xl border border-slate-100 bg-slate-50/50 p-3 text-left hover:border-orange-200 hover:bg-[#fff9f5] transition-all group"
              >
