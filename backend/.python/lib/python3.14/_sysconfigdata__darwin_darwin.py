...
build_time_vars = {
    ...
    "AR": "/tmp/tmp65dmjnoa/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    ...
    "CONFIG_ARGS": "'--build=aarch64-apple-darwin' '--host=aarch64-apple-darwin' '--prefix=/install' '--with-openssl=/tmp/tmp65dmjnoa/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--with-tail-call-interp' 'MODULE_BUILDTYPE=static' '--enable-loadable-sqlite-extensions' '--enable-static-libpython-for-interpreter' '--enable-shared' '--with-mimalloc' '--enable-optimizations' '--enable-experimental-jit=yes-off' '--with-lto' '--with-build-python=/tmp/tmp65dmjnoa/tools/host/bin/python3.14' 'ac_cv_lib_intl_textdomain=no' 'ac_cv_func_ptsname_r=no' 'ac_cv_func_explicit_bzero=no' '--with-dbmliborder=ndbm' 'build_alias=aarch64-apple-darwin' 'host_alias=aarch64-apple-darwin' 'PKG_CONFIG=pkg-config --static --define-prefix' 'PKG_CONFIG_PATH=/tmp/tmp65dmjnoa/tools/deps/share/pkgconfig:/tmp/tmp65dmjnoa/tools/deps/lib/pkgconfig' 'CC=clang' 'CFLAGS=-O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch arm64 -mmacosx-version-min=11.0   -Wl,-headerpad,40' 'CPPFLAGS=-O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'PROFILE_TASK=-m test --pgo -j 12' 'BOLT_COMMON_FLAGS=' 'BOLT_APPLY_FLAGS='",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.14",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/private/tmp/tmp65dmjnoa/Python-3.14.7/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/private/tmp/tmp65dmjnoa/Python-3.14.7/lcov-report",
    ...
    "FILEMODE": 644,
    "FREEZE_MODULE": "/tmp/tmp65dmjnoa/tools/host/bin/python3.14 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/tmp/tmp65dmjnoa/tools/host/bin/python3.14 ./Programs/_freeze_module.py",
    ...
    "LLVM_PROFDATA": "/tmp/tmp65dmjnoa/tools/llvm/bin/llvm-profdata",
    "LLVM_PROF_ERR": "no",
    "LLVM_PROF_FILE": "LLVM_PROFILE_FILE=\"$(shell pwd)/code-%128m.profclangr\"",
    "LLVM_PROF_MERGER": "/tmp/tmp65dmjnoa/tools/llvm/bin/llvm-profdata merge -output=\"$(shell pwd)/code.profclangd\" \"$(shell pwd)\"/*.profclangr",
    "LN": "ln",
    "LOCALMODLIBS": " -lmpdec -lm -lz -lbz2  -llzma -pthread -lpthread  -lzstd -pthread -lz -lreadline Modules/_hacl/libHacl_Hash_MD5.a Modules/_hacl/libHacl_Hash_SHA1.a Modules/_hacl/libHacl_Hash_SHA2.a Modules/_hacl/libHacl_Hash_SHA3.a Modules/_hacl/libHacl_Hash_BLAKE2.a Modules/_hacl/libHacl_HMAC.a -lexpat                      -lffi -ldl -lncurses -lpanel -lncurses  -lsqlite3 -lz   -lssl -lcrypto    -lcrypto -luuid -framework SystemConfiguration -framework CoreFoundation",
    "MACHDEP": "darwin",
    "MACHDEP_OBJS": "",
    ...
    "MIMALLOC_HEADERS": "\\",
    "MKDIR_P": "mkdir -p",
    "MODBUILT_NAMES": "_dbm  _testbuffer  _testcapi  _testlimitedcapi  _tkinter  array  _bisect  _csv  _heapq  _json  _lsprof  _pickle  _queue  _random  _remote_debugging  _struct  _interpreters  _interpchannels  _interpqueues  _zoneinfo  math  cmath  _statistics  _decimal  binascii  _bz2  _lzma  _zstd  zlib  readline  _md5  _sha1  _sha2  _sha3  _blake2  _hmac  pyexpat  _elementtree  _codecs_cn  _codecs_hk  _codecs_iso2022  _codecs_jp  _codecs_kr  _codecs_tw  _multibytecodec  unicodedata  fcntl  grp  mmap  _posixsubprocess  resource  select  _socket  syslog  termios  _posixshmem  _multiprocessing  _ctypes  _curses  _curses_panel  _sqlite3  _ssl  _hashlib  _uuid  _scproxy  xxsubtype  _xxtestfuzz  _testinternalcapi  _testimportmultiple  _testmultiphase  _testsinglephase  _ctypes_test  _asyncio  atexit  faulthandler  posix  _signal  _tracemalloc  _suggestions  _datetime  _codecs  _collections  errno  _io  itertools  _sre  _sysconfig  _thread  time  _types  _typing  _weakref  _abc  _functools  _locale  _opcode  _operator  _stat  _symtable  pwd",
    "MODDISABLED_NAMES": "_gdbm  _testclinic  _testclinic_limited  xx  xxlimited  xxlimited_35",
    "MODLIBS": " -lmpdec -lm -lz -lbz2  -llzma -pthread -lpthread  -lzstd -pthread -lz -lreadline Modules/_hacl/libHacl_Hash_MD5.a Modules/_hacl/libHacl_Hash_SHA1.a Modules/_hacl/libHacl_Hash_SHA2.a Modules/_hacl/libHacl_Hash_SHA3.a Modules/_hacl/libHacl_Hash_BLAKE2.a Modules/_hacl/libHacl_HMAC.a -lexpat                      -lffi -ldl -lncurses -lpanel -lncurses  -lsqlite3 -lz   -lssl -lcrypto    -lcrypto -luuid -framework SystemConfiguration -framework CoreFoundation",
    "MODOBJS": "Modules/arraymodule.o  Modules/_bisectmodule.o  Modules/_csv.o  Modules/_heapqmodule.o  Modules/_json.o  Modules/_lsprof.o Modules/rotatingtree.o  Modules/_pickle.o  Modules/_queuemodule.o  Modules/_randommodule.o  Modules/_remote_debugging_module.o  Modules/_struct.o  Modules/_interpretersmodule.o  Modules/_interpchannelsmodule.o  Modules/_interpqueuesmodule.o  Modules/_zoneinfo.o  Modules/mathmodule.o  Modules/cmathmodule.o  Modules/_statisticsmodule.o  Modules/_decimal/_decimal.o  Modules/binascii.o  Modules/_bz2module.o  Modules/_lzmamodule.o  Modules/_zstd/_zstdmodule.o Modules/_zstd/zstddict.o Modules/_zstd/compressor.o Modules/_zstd/decompressor.o  Modules/zlibmodule.o  Modules/readline.o  Modules/md5module.o  Modules/sha1module.o  Modules/sha2module.o  Modules/sha3module.o  Modules/blake2module.o  Modules/hmacmodule.o  Modules/pyexpat.o  Modules/_elementtree.o  Modules/cjkcodecs/_codecs_cn.o  Modules/cjkcodecs/_codecs_hk.o  Modules/cjkcodecs/_codecs_iso2022.o  Modules/cjkcodecs/_codecs_jp.o  Modules/cjkcodecs/_codecs_kr.o  Modules/cjkcodecs/_codecs_tw.o  Modules/cjkcodecs/multibytecodec.o  Modules/unicodedata.o  Modules/fcntlmodule.o  Modules/grpmodule.o  Modules/mmapmodule.o  Modules/_posixsubprocess.o  Modules/resource.o  Modules/selectmodule.o  Modules/socketmodule.o  Modules/syslogmodule.o  Modules/termios.o  Modules/_multiprocessing/posixshmem.o  Modules/_multiprocessing/multiprocessing.o Modules/_multiprocessing/semaphore.o  Modules/_ctypes/_ctypes.o Modules/_ctypes/callbacks.o Modules/_ctypes/callproc.o Modules/_ctypes/stgdict.o Modules/_ctypes/cfield.o Modules/_ctypes/malloc_closure.o  Modules/_cursesmodule.o  Modules/_curses_panel.o  Modules/_sqlite/blob.o Modules/_sqlite/connection.o Modules/_sqlite/cursor.o Modules/_sqlite/microprotocols.o Modules/_sqlite/module.o Modules/_sqlite/prepare_protocol.o Modules/_sqlite/row.o Modules/_sqlite/statement.o Modules/_sqlite/util.o  Modules/_ssl.o  Modules/_hashopenssl.o  Modules/_uuidmodule.o  Modules/_scproxy.o  Modules/xxsubtype.o  Modules/_xxtestfuzz/_xxtestfuzz.o Modules/_xxtestfuzz/fuzzer.o  Modules/_testinternalcapi.o Modules/_testinternalcapi/test_lock.o Modules/_testinternalcapi/pytime.o Modules/_testinternalcapi/set.o Modules/_testinternalcapi/test_critical_sections.o Modules/_testinternalcapi/complex.o  Modules/_asynciomodule.o  Modules/atexitmodule.o  Modules/faulthandler.o  Modules/posixmodule.o  Modules/signalmodule.o  Modules/_tracemalloc.o  Modules/_suggestions.o  Modules/_datetimemodule.o  Modules/_codecsmodule.o  Modules/_collectionsmodule.o  Modules/errnomodule.o  Modules/_io/_iomodule.o Modules/_io/iobase.o Modules/_io/fileio.o Modules/_io/bytesio.o Modules/_io/bufferedio.o Modules/_io/textio.o Modules/_io/stringio.o  Modules/itertoolsmodule.o  Modules/_sre/sre.o  Modules/_sysconfig.o  Modules/_threadmodule.o  Modules/timemodule.o  Modules/_typesmodule.o  Modules/_typingmodule.o  Modules/_weakref.o  Modules/_abc.o  Modules/_functoolsmodule.o  Modules/_localemodule.o  Modules/_opcode.o  Modules/_operator.o  Modules/_stat.o  Modules/symtablemodule.o  Modules/pwdmodule.o",
    "MODSHARED_NAMES": "_dbm _testbuffer _testcapi _testlimitedcapi _tkinter _testimportmultiple _testmultiphase _testsinglephase _ctypes_test",
    ...
    "MODULE__CTYPES_CFLAGS": "-fno-strict-overflow  -DUSING_MALLOC_CLOSURE_DOT_C=1",
    ...
    "MODULE__SQLITE3_LDFLAGS": " -lsqlite3 -lz",
    ...
    "MODULE__TKINTER_LDFLAGS": " -ltcl9tk9.0 -ltkstub -ltcl9.0 -ltclstub -lz -lpthread -framework CoreFoundation",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/tmp/tmp65dmjnoa/Python-3.14.7 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmp65dmjnoa/Python-3.14.7/`cat pybuilddir.txt`) /tmp/tmp65dmjnoa/tools/host/bin/python3.14",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/tmp/tmp65dmjnoa/tools/host/bin/python3.14",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "RESSRCDIR": "",
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/tmp/tmp65dmjnoa/Python-3.14.7",
    "SCRIPTDIR": "/install/lib",
    "SCRIPT_IDLE": "build/scripts-3.14/idle3.14",
    "SCRIPT_PYDOC": "build/scripts-3.14/pydoc3.14",
    "SETPGRP_HAVE_ARG": 0,
    "SHAREDMODS": "Modules/_dbm.cpython-314-darwin.so Modules/_testbuffer.cpython-314-darwin.so Modules/_testcapi.cpython-314-darwin.so Modules/_testlimitedcapi.cpython-314-darwin.so Modules/_tkinter.cpython-314-darwin.so Modules/_testimportmultiple.cpython-314-darwin.so Modules/_testmultiphase.cpython-314-darwin.so Modules/_testsinglephase.cpython-314-darwin.so Modules/_ctypes_test.cpython-314-darwin.so",
    "SHELL": "/bin/sh -e",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/tmp/tmp65dmjnoa/Python-3.14.7 _PYTHON_PROJECT_BASE=/private/tmp/tmp65dmjnoa/Python-3.14.7 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmp65dmjnoa/Python-3.14.7/`cat pybuilddir.txt`) /tmp/tmp65dmjnoa/tools/host/bin/python3.14",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/tmp/tmp65dmjnoa/Python-3.14.7 _PYTHON_PROJECT_BASE=/private/tmp/tmp65dmjnoa/Python-3.14.7 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmp65dmjnoa/Python-3.14.7/`cat pybuilddir.txt`) /tmp/tmp65dmjnoa/tools/host/bin/python3.14 -m test",
    ...
    "abs_builddir": "/private/tmp/tmp65dmjnoa/Python-3.14.7",
    "abs_srcdir": "/private/tmp/tmp65dmjnoa/Python-3.14.7",
